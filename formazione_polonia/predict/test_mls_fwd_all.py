...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_polonia/diagnostics/
...
# formazione_polonia/diagnostics/validate_outlier_shrinkage.py (variabile
...
def build_prediction(player_slug):
    ...
    # formazione_polonia/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='polonia', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
