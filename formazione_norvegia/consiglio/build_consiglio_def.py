...
OUTPUT_DIR = 'formazione_norvegia/output/norvegia_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_norvegia/output/norvegia_def_discovery', 'player_slugs.json')
