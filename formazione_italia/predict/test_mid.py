"""
test_mid (test centrocampista Serie A (Italia) — prototipo, clone adattato di test_mls_fwd_all.py)
...
# Fallback statico SOLO se italia_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'italia', 'mid', next_opponent_team_slug, _opp_cutoff)
    ...
    opponent_forte_flags = [
        opponent_strength.opponent_is_strong('italia', opp_slug, dt)
