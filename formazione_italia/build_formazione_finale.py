...
ROLES = {
    'GK': 'formazione_italia/output/italia_gk_all',
    'DEF': 'formazione_italia/output/italia_def_all',
    'MID': 'formazione_italia/output/italia_mid_all',
    'FWD': 'formazione_italia/output/italia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_italia/output/italia_gk_discovery',
    'DEF': 'formazione_italia/output/italia_def_discovery',
    'MID': 'formazione_italia/output/italia_mid_discovery',
    'FWD': 'formazione_italia/output/italia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_italia/output'
