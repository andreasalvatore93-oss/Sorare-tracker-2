...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_romania/diagnostics/
...
# formazione_romania/diagnostics/validate_outlier_shrinkage.py (variabile
...
def build_prediction(player_slug):
    ...
    # formazione_romania/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='romania', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
