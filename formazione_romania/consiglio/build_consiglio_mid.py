...
OUTPUT_DIR = 'formazione_romania/output/romania_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_romania/output/romania_mid_discovery', 'player_slugs.json')
