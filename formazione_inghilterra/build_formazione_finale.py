...
ROLES = {
    'GK': 'formazione_inghilterra/output/inghilterra_gk_all',
    'DEF': 'formazione_inghilterra/output/inghilterra_def_all',
    'MID': 'formazione_inghilterra/output/inghilterra_mid_all',
    'FWD': 'formazione_inghilterra/output/inghilterra_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_inghilterra/output/inghilterra_gk_discovery',
    'DEF': 'formazione_inghilterra/output/inghilterra_def_discovery',
    'MID': 'formazione_inghilterra/output/inghilterra_mid_discovery',
    'FWD': 'formazione_inghilterra/output/inghilterra_fwd_discovery',
}

OUTPUT_DIR = 'formazione_inghilterra/output'
