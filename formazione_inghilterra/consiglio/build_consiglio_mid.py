...
OUTPUT_DIR = 'formazione_inghilterra/output/inghilterra_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_inghilterra/output/inghilterra_mid_discovery', 'player_slugs.json')
