"""
Premier League (Inghilterra) Midfielder Discovery
...
Output: inghilterra_mid_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_inghilterra/output/inghilterra_mid_discovery'
...
def log(msg):
    ...
    print(f"[{ts}] [inghilterra_mid_discovery] {msg}")
...
def discover_inghilterra_midfielders_all(user_slug=USER_SLUG, max_pages=50):
...
def main():
    log("Avvio discovery centrocampisti Premier League (Inghilterra) (in_season + classic)...")
    slugs, card_counts = discover_inghilterra_midfielders_all()
