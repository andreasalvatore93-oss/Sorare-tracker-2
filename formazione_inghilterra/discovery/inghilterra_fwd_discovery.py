"""
Premier League (Inghilterra) Forward Discovery
...
Output: inghilterra_fwd_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_inghilterra/output/inghilterra_fwd_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [inghilterra_fwd_discovery] {msg}")
...
def discover_inghilterra_forwards_all(user_slug=USER_SLUG, max_pages=50):
...
def main():
    log("Avvio discovery attaccanti Premier League (Inghilterra) (in_season + classic)...")
    slugs, card_counts = discover_inghilterra_forwards_all()
