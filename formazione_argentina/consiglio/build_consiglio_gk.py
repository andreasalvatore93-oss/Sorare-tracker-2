...
OUTPUT_DIR = 'formazione_argentina/output/argentina_gk_all'
...
# sempre).
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_argentina/output/argentina_gk_discovery', 'player_slugs.json')
