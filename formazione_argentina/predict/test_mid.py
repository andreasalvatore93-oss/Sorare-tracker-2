"""
test_mid (test centrocampista Liga Profesional (Argentina) — prototipo, clone adattato di test_mls_fwd_all.py)
...
# Fallback statico SOLO se argentina_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'argentina', 'mid', next_opponent_team_slug, _opp_cutoff)
    ...
    opponent_forte_flags = [
        opponent_strength.opponent_is_strong('argentina', opp_slug, dt)
