...
ROLES = {
    'GK': 'formazione_argentina/output/argentina_gk_all',
    'DEF': 'formazione_argentina/output/argentina_def_all',
    'MID': 'formazione_argentina/output/argentina_mid_all',
    'FWD': 'formazione_argentina/output/argentina_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_argentina/output/argentina_gk_discovery',
    'DEF': 'formazione_argentina/output/argentina_def_discovery',
    'MID': 'formazione_argentina/output/argentina_mid_discovery',
    'FWD': 'formazione_argentina/output/argentina_fwd_discovery',
}

OUTPUT_DIR = 'formazione_argentina/output'
