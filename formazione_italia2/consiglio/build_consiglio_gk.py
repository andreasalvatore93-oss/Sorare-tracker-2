...
OUTPUT_DIR = 'formazione_italia2/output/italia2_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_italia2/output/italia2_gk_discovery', 'player_slugs.json')
