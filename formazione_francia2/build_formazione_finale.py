...
ROLES = {
    'GK': 'formazione_francia2/output/francia2_gk_all',
    'DEF': 'formazione_francia2/output/francia2_def_all',
    'MID': 'formazione_francia2/output/francia2_mid_all',
    'FWD': 'formazione_francia2/output/francia2_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_francia2/output/francia2_gk_discovery',
    'DEF': 'formazione_francia2/output/francia2_def_discovery',
    'MID': 'formazione_francia2/output/francia2_mid_discovery',
    'FWD': 'formazione_francia2/output/francia2_fwd_discovery',
}

OUTPUT_DIR = 'formazione_francia2/output'
