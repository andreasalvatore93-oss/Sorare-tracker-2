...
# formazione_francia2/predict/test_gk.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_francia2/output/francia2_gk_discovery_global' if CALIBRATION_MODE else 'formazione_francia2/output/francia2_gk_discovery',
    'player_slugs.json')
...
OUTPUT_DIR = 'formazione_francia2/output/francia2_gk_calibration' if CALIBRATION_MODE else 'formazione_francia2/output/francia2_gk_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_francia2_gk.marker'
...
def venue_factor_gk(scores, is_home_flags, target_is_home, weights):
    ...
    non sui residui: verificato il 31/07 (formazione_francia2/diagnostics/
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'francia2', 'gk', next_opponent_team_slug, _opp_cutoff)
    ...
    # -0.13% MAE (formazione_francia2/diagnostics/validate_cross_role_combos.py,
    ...
    # backtest walk-forward rigoroso su dati reali (formazione_francia2/diagnostics/
