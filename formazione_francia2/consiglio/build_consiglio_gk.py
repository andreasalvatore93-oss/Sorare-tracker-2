...
OUTPUT_DIR = 'formazione_francia2/output/francia2_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_francia2/output/francia2_gk_discovery', 'player_slugs.json')
