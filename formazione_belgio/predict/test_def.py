...
# formazione_belgio/predict/test_def.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_belgio/output/belgio_def_discovery_global' if CALIBRATION_MODE else 'formazione_belgio/output/belgio_def_discovery',
    'player_slugs.json')
...
# (formazione_belgio/diagnostics/validate_outlier_shrinkage.py) mostra che tirare
...
OUTPUT_DIR = 'formazione_belgio/output/belgio_def_calibration' if CALIBRATION_MODE else 'formazione_belgio/output/belgio_def_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_belgio_def.marker'
...
# Logica identica a formazione_belgio/diagnostics/validate_level_score_event_rate.py,
...
def compute_score_atteso_def(scores, is_home_flags, opponent_rankings,
                             ...
                             next_opponent_team_slug=None, next_game_date=None, league='belgio',
...
def rigorous_backtest_prod_def(scores, is_home_flags, opponent_rankings,
                               ...
                               opponent_team_slugs_hist=None, game_dates_hist=None, league='belgio',
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'belgio', 'def', next_opponent_team_slug, _opp_cutoff)
    ...
    # formazione_belgio/diagnostics/selection_quality.py (lift catturato fra
    ...
    score_ordinamento = compute_score_atteso_def(
        ...
        league='belgio', detail_ok_flags=detail_ok_flags)
