...
ROLES = {
    'GK': 'formazione_belgio/output/belgio_gk_all',
    'DEF': 'formazione_belgio/output/belgio_def_all',
    'MID': 'formazione_belgio/output/belgio_mid_all',
    'FWD': 'formazione_belgio/output/belgio_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_belgio/output/belgio_gk_discovery',
    'DEF': 'formazione_belgio/output/belgio_def_discovery',
    'MID': 'formazione_belgio/output/belgio_mid_discovery',
    'FWD': 'formazione_belgio/output/belgio_fwd_discovery',
}

OUTPUT_DIR = 'formazione_belgio/output'
