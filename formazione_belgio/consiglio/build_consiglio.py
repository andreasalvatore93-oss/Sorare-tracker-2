...
OUTPUT_DIR = 'formazione_belgio/output/belgio_fwd_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_belgio/output/belgio_fwd_discovery', 'player_slugs.json')
