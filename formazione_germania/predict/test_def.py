...
# Fallback statico SOLO se germania_def_discovery/player_slugs.json non esiste
...
# Portogallo, Austria, Scozia, Germania, Olanda, Spagna), ricalibrata sessione
...
def _build_grid_combinations_prod():
    combos = []
    # ALLARGATA (30/07), stesso motivo del grid principale.
