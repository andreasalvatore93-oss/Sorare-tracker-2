...
ROLES = {
    'GK': 'formazione_germania/output/germania_gk_all',
    'DEF': 'formazione_germania/output/germania_def_all',
    'MID': 'formazione_germania/output/germania_mid_all',
    'FWD': 'formazione_germania/output/germania_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_germania/output/germania_gk_discovery',
    'DEF': 'formazione_germania/output/germania_def_discovery',
    'MID': 'formazione_germania/output/germania_mid_discovery',
    'FWD': 'formazione_germania/output/germania_fwd_discovery',
}

OUTPUT_DIR = 'formazione_germania/output'
