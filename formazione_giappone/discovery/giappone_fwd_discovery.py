"""
J1 League (Giappone) Forward Discovery
...
Output: giappone_fwd_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_giappone/output/giappone_fwd_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [giappone_fwd_discovery] {msg}")
...
def discover_giappone_forwards_all(user_slug=USER_SLUG, max_pages=50):
...
def main():
    log("Avvio discovery attaccanti J1 League (Giappone) (in_season + classic)...")
    slugs, card_counts = discover_giappone_forwards_all()
