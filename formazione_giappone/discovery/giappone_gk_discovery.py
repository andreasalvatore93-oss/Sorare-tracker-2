"""
J1 League (Giappone) Goalkeeper Discovery
...
Output: giappone_gk_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_giappone/output/giappone_gk_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [giappone_gk_discovery] {msg}")
...
def discover_giappone_goalkeepers_all(user_slug=USER_SLUG, max_pages=50):
...
def main():
    log("Avvio discovery portieri J1 League (Giappone) (in_season + classic)...")
    slugs, card_counts = discover_giappone_goalkeepers_all()
