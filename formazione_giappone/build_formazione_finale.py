...
ROLES = {
    'GK': 'formazione_giappone/output/giappone_gk_all',
    'DEF': 'formazione_giappone/output/giappone_def_all',
    'MID': 'formazione_giappone/output/giappone_mid_all',
    'FWD': 'formazione_giappone/output/giappone_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_giappone/output/giappone_gk_discovery',
    'DEF': 'formazione_giappone/output/giappone_def_discovery',
    'MID': 'formazione_giappone/output/giappone_mid_discovery',
    'FWD': 'formazione_giappone/output/giappone_fwd_discovery',
}

OUTPUT_DIR = 'formazione_giappone/output'
