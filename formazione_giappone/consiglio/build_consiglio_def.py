...
OUTPUT_DIR = 'formazione_giappone/output/giappone_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_giappone/output/giappone_def_discovery', 'player_slugs.json')
