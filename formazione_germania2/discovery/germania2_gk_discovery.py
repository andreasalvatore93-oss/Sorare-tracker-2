"""
2. Bundesliga (Germania) Goalkeeper Discovery
...
Output: germania2_gk_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_germania2/output/germania2_gk_discovery'
...
def log(msg):
    ...
    print(f"[{ts}] [germania2_gk_discovery] {msg}")
...
def discover_germania2_goalkeepers_all(user_slug=USER_SLUG, max_pages=50):
    ...
    Goalkeeper posseduti (qualunque lega) e scarta quelli non Germania
    dopo il fetch."""
...
def main():
    log("Avvio discovery portieri 2. Bundesliga (Germania) (in_season + classic)...")
    slugs, card_counts = discover_germania2_goalkeepers_all()
