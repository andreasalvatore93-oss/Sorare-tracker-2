"""
2. Bundesliga (Germania) Midfielder Discovery
...
Output: germania2_mid_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_germania2/output/germania2_mid_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [germania2_mid_discovery] {msg}")
...
def discover_germania2_midfielders_all(user_slug=USER_SLUG, max_pages=50):
    ...
    Midfielder posseduti (qualunque lega) e scarta quelli non Germania
    dopo il fetch."""
...
def main():
    log("Avvio discovery centrocampisti 2. Bundesliga (Germania) (in_season + classic)...")
    slugs, card_counts = discover_germania2_midfielders_all()
