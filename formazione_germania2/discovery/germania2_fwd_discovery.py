"""
2. Bundesliga (Germania) Forward Discovery
...
Output: germania2_fwd_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_germania2/output/germania2_fwd_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [germania2_fwd_discovery] {msg}")
...
def discover_germania2_forwards_all(user_slug=USER_SLUG, max_pages=50):
    ...
    Forward posseduti (qualunque lega) e scarta quelli non Germania
    dopo il fetch."""
...
def main():
    log("Avvio discovery attaccanti 2. Bundesliga (Germania) (in_season + classic)...")
    slugs, card_counts = discover_germania2_forwards_all()
