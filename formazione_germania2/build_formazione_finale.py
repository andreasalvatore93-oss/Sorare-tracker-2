...
ROLES = {
    'GK': 'formazione_germania2/output/germania2_gk_all',
    'DEF': 'formazione_germania2/output/germania2_def_all',
    'MID': 'formazione_germania2/output/germania2_mid_all',
    'FWD': 'formazione_germania2/output/germania2_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_germania2/output/germania2_gk_discovery',
    'DEF': 'formazione_germania2/output/germania2_def_discovery',
    'MID': 'formazione_germania2/output/germania2_mid_discovery',
    'FWD': 'formazione_germania2/output/germania2_fwd_discovery',
}

OUTPUT_DIR = 'formazione_germania2/output'
