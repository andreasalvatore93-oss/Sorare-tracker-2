...
OUTPUT_DIR = 'formazione_germania2/output/germania2_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_germania2/output/germania2_def_discovery', 'player_slugs.json')
