...
OUTPUT_DIR = 'formazione_turchia/output/turchia_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_turchia/output/turchia_gk_discovery', 'player_slugs.json')
