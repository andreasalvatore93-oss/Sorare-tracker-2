...
ROLES = {
    'GK': 'formazione_turchia/output/turchia_gk_all',
    'DEF': 'formazione_turchia/output/turchia_def_all',
    'MID': 'formazione_turchia/output/turchia_mid_all',
    'FWD': 'formazione_turchia/output/turchia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_turchia/output/turchia_gk_discovery',
    'DEF': 'formazione_turchia/output/turchia_def_discovery',
    'MID': 'formazione_turchia/output/turchia_mid_discovery',
    'FWD': 'formazione_turchia/output/turchia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_turchia/output'
