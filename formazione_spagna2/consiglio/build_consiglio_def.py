...
OUTPUT_DIR = 'formazione_spagna2/output/spagna2_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_spagna2/output/spagna2_def_discovery', 'player_slugs.json')
