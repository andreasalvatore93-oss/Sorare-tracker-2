...
OUTPUT_DIR = 'formazione_spagna2/output/spagna2_fwd_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_spagna2/output/spagna2_fwd_discovery', 'player_slugs.json')
