...
ROLES = {
    'GK': 'formazione_spagna/output/spagna_gk_all',
    'DEF': 'formazione_spagna/output/spagna_def_all',
    'MID': 'formazione_spagna/output/spagna_mid_all',
    'FWD': 'formazione_spagna/output/spagna_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_spagna/output/spagna_gk_discovery',
    'DEF': 'formazione_spagna/output/spagna_def_discovery',
    'MID': 'formazione_spagna/output/spagna_mid_discovery',
    'FWD': 'formazione_spagna/output/spagna_fwd_discovery',
}

OUTPUT_DIR = 'formazione_spagna/output'
