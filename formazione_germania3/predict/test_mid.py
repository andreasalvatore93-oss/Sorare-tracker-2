...
# Fallback statico SOLO se germania3_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'germania3', 'mid', next_opponent_team_slug, _opp_cutoff)
    ...
    opponent_forte_flags = [
        opponent_strength.opponent_is_strong('germania3', opp_slug, dt)
