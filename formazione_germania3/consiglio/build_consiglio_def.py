...
OUTPUT_DIR = 'formazione_germania3/output/germania3_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_germania3/output/germania3_def_discovery', 'player_slugs.json')
