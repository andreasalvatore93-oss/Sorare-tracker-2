...
Output: mls_mid_discovery/player_slugs.json -- lista JSON di slug univoci,
...
def log(msg):
    ...
    print(f"[{ts}] [mls_mid_discovery] {msg}")
...
def discover_mls_midfielders_in_season(user_slug=USER_SLUG, max_pages=50):
    ...
    query = """
    query MlsMidfielderDiscovery($userSlug: String!, $page: Int!, $pageSize: Int!,
...
def main():
    ...
    slugs = discover_mls_midfielders_in_season()
