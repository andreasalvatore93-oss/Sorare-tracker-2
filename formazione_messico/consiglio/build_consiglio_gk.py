...
OUTPUT_DIR = 'formazione_messico/output/messico_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_messico/output/messico_gk_discovery', 'player_slugs.json')
