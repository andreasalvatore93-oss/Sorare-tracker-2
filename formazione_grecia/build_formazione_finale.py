...
ROLES = {
    'GK': 'formazione_grecia/output/grecia_gk_all',
    'DEF': 'formazione_grecia/output/grecia_def_all',
    'MID': 'formazione_grecia/output/grecia_mid_all',
    'FWD': 'formazione_grecia/output/grecia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_grecia/output/grecia_gk_discovery',
    'DEF': 'formazione_grecia/output/grecia_def_discovery',
    'MID': 'formazione_grecia/output/grecia_mid_discovery',
    'FWD': 'formazione_grecia/output/grecia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_grecia/output'
