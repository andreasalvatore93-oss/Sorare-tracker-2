...
def build_prediction(player_slug):
    ...
    # RISCRITTO (03/08): era un moltiplicatore su lambda_pos. Vedi
    # opponent_strength.gk_def_pen_area_granular_delta: la validazione
    # misurava un delta ADDITIVO sul granulare di parate, e il segno era
    # rovesciato (lambda_pos del portiere e' dominato da clean_sheet_60).
