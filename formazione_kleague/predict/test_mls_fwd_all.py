...
DISCOVERY_FILE = os.path.join(
    'formazione_kleague/output/kleague_fwd_discovery_global' if CALIBRATION_MODE else 'formazione_kleague/output/kleague_fwd_discovery',
    'player_slugs.json')
...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_kleague/diagnostics/
...
# formazione_kleague/diagnostics/validate_outlier_shrinkage.py (variabile
...
def build_prediction(player_slug):
    ...
    # formazione_kleague/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='kleague', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
