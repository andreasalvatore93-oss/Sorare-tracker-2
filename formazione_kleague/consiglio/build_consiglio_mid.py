...
OUTPUT_DIR = 'formazione_kleague/output/kleague_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_kleague/output/kleague_mid_discovery', 'player_slugs.json')
