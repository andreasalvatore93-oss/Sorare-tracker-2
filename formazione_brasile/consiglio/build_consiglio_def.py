...
OUTPUT_DIR = 'formazione_brasile/output/brasile_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_brasile/output/brasile_def_discovery', 'player_slugs.json')
