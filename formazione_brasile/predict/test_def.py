...
# (formazione_brasile/diagnostics/validate_outlier_shrinkage.py) mostra che tirare
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_brasile_def.marker'
...
# Logica identica a formazione_brasile/diagnostics/validate_level_score_event_rate.py,
...
def rigorous_backtest_prod_def(scores, is_home_flags, opponent_rankings,
                               ...
                               opponent_team_slugs_hist=None, game_dates_hist=None, league='brasile',
...
def build_prediction(player_slug):
    ...
    if CALIBRATION_MODE and not future_games:
        ...
        grid_results = run_grid_search_prod_def(
            ...
            min_history=6,
            opponent_team_slugs_hist=opponent_team_slugs_hist,
            game_dates_hist=game_dates_hist, league='brasile',
            presence_rate=presence_rate, detail_ok_flags=detail_ok_flags)
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'brasile', 'def', next_opponent_team_slug, _opp_cutoff)
    ...
    # formazione_brasile/diagnostics/selection_quality.py (lift catturato fra
    ...
    score_ordinamento = compute_score_atteso_def(
        ...
        league='brasile', detail_ok_flags=detail_ok_flags)
