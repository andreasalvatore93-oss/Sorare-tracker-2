...
ROLES = {
    'GK': 'formazione_portogallo/output/portogallo_gk_all',
    'DEF': 'formazione_portogallo/output/portogallo_def_all',
    'MID': 'formazione_portogallo/output/portogallo_mid_all',
    'FWD': 'formazione_portogallo/output/portogallo_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_portogallo/output/portogallo_gk_discovery',
    'DEF': 'formazione_portogallo/output/portogallo_def_discovery',
    'MID': 'formazione_portogallo/output/portogallo_mid_discovery',
    'FWD': 'formazione_portogallo/output/portogallo_fwd_discovery',
}

OUTPUT_DIR = 'formazione_portogallo/output'
