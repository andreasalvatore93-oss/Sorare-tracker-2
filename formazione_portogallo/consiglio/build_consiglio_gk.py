...
OUTPUT_DIR = 'formazione_portogallo/output/portogallo_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_portogallo/output/portogallo_gk_discovery', 'player_slugs.json')
