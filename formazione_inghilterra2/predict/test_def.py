...
# Fallback statico SOLO se inghilterra2_def_discovery/player_slugs.json non esiste
...
# Portogallo, Austria, Scozia, Inghilterra, Olanda, Spagna), ricalibrata sessione
