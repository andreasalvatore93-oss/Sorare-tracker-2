...
ROLES = {
    'GK': 'formazione_inghilterra2/output/inghilterra2_gk_all',
    'DEF': 'formazione_inghilterra2/output/inghilterra2_def_all',
    'MID': 'formazione_inghilterra2/output/inghilterra2_mid_all',
    'FWD': 'formazione_inghilterra2/output/inghilterra2_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_inghilterra2/output/inghilterra2_gk_discovery',
    'DEF': 'formazione_inghilterra2/output/inghilterra2_def_discovery',
    'MID': 'formazione_inghilterra2/output/inghilterra2_mid_discovery',
    'FWD': 'formazione_inghilterra2/output/inghilterra2_fwd_discovery',
}

OUTPUT_DIR = 'formazione_inghilterra2/output'
