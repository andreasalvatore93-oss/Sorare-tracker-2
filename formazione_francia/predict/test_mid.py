"""
test_mid (test centrocampista Ligue 1 (Francia) — prototipo, clone adattato di test_mls_fwd_all.py)
...
# Fallback statico SOLO se francia_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'francia', 'mid', next_opponent_team_slug, _opp_cutoff)
    ...
    opponent_forte_flags = [
        opponent_strength.opponent_is_strong('francia', opp_slug, dt)
