...
ROLES = {
    'GK': 'formazione_francia/output/francia_gk_all',
    'DEF': 'formazione_francia/output/francia_def_all',
    'MID': 'formazione_francia/output/francia_mid_all',
    'FWD': 'formazione_francia/output/francia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_francia/output/francia_gk_discovery',
    'DEF': 'formazione_francia/output/francia_def_discovery',
    'MID': 'formazione_francia/output/francia_mid_discovery',
    'FWD': 'formazione_francia/output/francia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_francia/output'
