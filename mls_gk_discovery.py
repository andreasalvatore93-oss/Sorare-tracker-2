...
def discover_mls_goalkeepers_in_season(user_slug=USER_SLUG, max_pages=50):
    """Ritorna la lista deduplicata di slug giocatore (Goalkeeper, in_season,
    ...
    while page <= max_pages:
        ...
        if page == 1:
            log(f"Totale carte Goalkeeper/in_season/MLS trovate: {search.get('nbHits')} "
...
def main():
    log("Avvio discovery portieri MLS in_season...")
    slugs, card_counts = discover_mls_goalkeepers_in_season()
