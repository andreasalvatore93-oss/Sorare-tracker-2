...
OUTPUT_DIR = 'formazione_cile/output/cile_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_cile/output/cile_gk_discovery', 'player_slugs.json')
