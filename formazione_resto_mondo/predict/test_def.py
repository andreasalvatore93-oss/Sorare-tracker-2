...
# (formazione_resto_mondo/diagnostics/validate_outlier_shrinkage.py) mostra che tirare
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_resto_mondo_def.marker'
...
# Logica identica a formazione_resto_mondo/diagnostics/validate_level_score_event_rate.py,
...
def compute_score_atteso_def(scores, is_home_flags, opponent_rankings,
                             ...
                             next_opponent_team_slug=None, next_game_date=None, league='resto_mondo',
...
def rigorous_backtest_prod_def(scores, is_home_flags, opponent_rankings,
                               ...
                               opponent_team_slugs_hist=None, game_dates_hist=None, league='resto_mondo',
...
def build_prediction(player_slug):
    ...
    if CALIBRATION_MODE and not future_games:
        ...
        grid_results = run_grid_search_prod_def(
            ...
            min_history=6,
            opponent_team_slugs_hist=opponent_team_slugs_hist,
            game_dates_hist=game_dates_hist, league='resto_mondo',
            presence_rate=presence_rate, detail_ok_flags=detail_ok_flags)
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'resto_mondo', 'def', next_opponent_team_slug, _opp_cutoff)
    ...
    # formazione_resto_mondo/diagnostics/selection_quality.py (lift catturato fra
    ...
    score_ordinamento = compute_score_atteso_def(
        ...
        league='resto_mondo', detail_ok_flags=detail_ok_flags)
