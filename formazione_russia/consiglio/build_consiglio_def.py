...
OUTPUT_DIR = 'formazione_russia/output/russia_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_russia/output/russia_def_discovery', 'player_slugs.json')
