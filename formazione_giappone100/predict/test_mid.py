"""
test_mid (test centrocampista J1 100 Year Vision League (Giappone) — prototipo, clone adattato di test_mls_fwd_all.py)
...
# Fallback statico SOLO se giappone100_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'giappone100', 'mid', next_opponent_team_slug, _opp_cutoff)
    ...
    opponent_forte_flags = [
        opponent_strength.opponent_is_strong('giappone100', opp_slug, dt)
