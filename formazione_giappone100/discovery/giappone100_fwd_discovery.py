"""
J1 100 Year Vision League (Giappone) Forward Discovery
...
Output: giappone100_fwd_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_giappone100/output/giappone100_fwd_discovery'
...
def log(msg):
    ...
    print(f"[{ts}] [giappone100_fwd_discovery] {msg}")
...
def discover_giappone100_forwards_all(user_slug=USER_SLUG, max_pages=50):
    ...
    Forward posseduti (qualunque lega) e scarta quelli non Giappone
    dopo il fetch."""
...
def main():
    log("Avvio discovery attaccanti J1 100 Year Vision League (Giappone) (in_season + classic)...")
    slugs, card_counts = discover_giappone100_forwards_all()
