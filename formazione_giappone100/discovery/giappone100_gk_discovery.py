"""
J1 100 Year Vision League (Giappone) Goalkeeper Discovery
...
Output: giappone100_gk_discovery/player_slugs.json -- lista JSON di slug
...
USER_SLUG = 'crowss'
OUTPUT_DIR = 'formazione_giappone100/output/giappone100_gk_discovery'
PAGE_SIZE = 20
...
def log(msg):
    ...
    print(f"[{ts}] [giappone100_gk_discovery] {msg}")
...
def discover_giappone100_goalkeepers_all(user_slug=USER_SLUG, max_pages=50):
    ...
    Goalkeeper posseduti (qualunque lega) e scarta quelli non Giappone
    dopo il fetch."""
...
def main():
    log("Avvio discovery portieri J1 100 Year Vision League (Giappone) (in_season + classic)...")
    slugs, card_counts = discover_giappone100_goalkeepers_all()
