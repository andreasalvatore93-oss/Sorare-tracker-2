...
ROLES = {
    'GK': 'formazione_olanda/output/olanda_gk_all',
    'DEF': 'formazione_olanda/output/olanda_def_all',
    'MID': 'formazione_olanda/output/olanda_mid_all',
    'FWD': 'formazione_olanda/output/olanda_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_olanda/output/olanda_gk_discovery',
    'DEF': 'formazione_olanda/output/olanda_def_discovery',
    'MID': 'formazione_olanda/output/olanda_mid_discovery',
    'FWD': 'formazione_olanda/output/olanda_fwd_discovery',
}

OUTPUT_DIR = 'formazione_olanda/output'
