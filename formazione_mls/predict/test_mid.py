...
# formazione_mls/predict/test_mid.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_mls/output/mls_mid_discovery_global' if CALIBRATION_MODE else 'formazione_mls/output/mls_mid_discovery',
    'player_slugs.json')
