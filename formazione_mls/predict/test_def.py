...
# formazione_mls/predict/test_def.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_mls/output/mls_def_discovery_global' if CALIBRATION_MODE else 'formazione_mls/output/mls_def_discovery',
    'player_slugs.json')
...
OUTPUT_DIR = 'formazione_mls/output/mls_def_calibration' if CALIBRATION_MODE else 'formazione_mls/output/mls_def_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_mls_def.marker'
...
# Logica identica a formazione_mls/diagnostics/validate_level_score_event_rate.py,
...
def build_prediction(player_slug):
    ...
    score_ordinamento = compute_score_atteso_def(
        ...
        league='mls', detail_ok_flags=detail_ok_flags)
