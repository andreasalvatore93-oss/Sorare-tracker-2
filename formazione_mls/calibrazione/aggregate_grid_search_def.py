"""
aggregate_grid_search_def.py

Aggrega i risultati del grid search (72 combinazioni) salvati da test_mid.py
per ogni difensore (mls_def_all/grid_search/<slug>_grid.json), calcola
...
def log(msg):
    ...
    print(f"[{ts}] [aggregate_grid_search_def] {msg}")
...
def main():
    ...
    lines = []
    lines.append("=" * 70)
    lines.append("GRID SEARCH CROSS-PLAYER DIFENSORI — CLASSIFICA COMBINAZIONI")
