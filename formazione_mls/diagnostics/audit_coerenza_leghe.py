...
PATTERNS = {
    'gk': ('test_gk.py', [
        ('HALF_LIFE_GAMES', r'^HALF_LIFE_GAMES\s*=\s*([\d.]+)'),
        ('TREND_INTENSITY', r'^TREND_INTENSITY\s*=\s*([\d.]+)'),
        ('SHRINK_K_OUTLIER_GK', r'^\s*SHRINK_K_OUTLIER_GK\s*=\s*([\d.]+)'),
        ('MEDIA_RUOLO_GK_PRIOR', r'^\s*MEDIA_RUOLO_GK_PRIOR\s*=\s*([\d.]+)'),
        ('SPLIT_SHRINK_K_GK', r'SPLIT_SHRINK_K_GK\s*=\s*([\d.]+)'),
        ('prior_dinamico', PRIOR_RE),
    ]),
    'def': ('test_def.py', [
        ('HALF_LIFE_GAMES', r'^HALF_LIFE_GAMES\s*=\s*([\d.]+)'),
        ('TREND_INTENSITY', r'^TREND_INTENSITY\s*=\s*([\d.]+)'),
        ('SHRINK_K_OUTLIER_DEF', r'^\s*SHRINK_K_OUTLIER_DEF\s*=\s*([\d.]+)'),
        ('MEDIA_RUOLO_DEF_PRIOR', r'^\s*MEDIA_RUOLO_DEF_PRIOR\s*=\s*([\d.]+)'),
        ('SPLIT_SHRINK_K', r'SPLIT_SHRINK_K\s*=\s*([\d.]+)'),
        ('prior_dinamico', PRIOR_RE),
    ]),
    'mid': ('test_mid.py', [
        ('HALF_LIFE_GAMES', r'^HALF_LIFE_GAMES\s*=\s*([\d.]+)'),
        ('TREND_INTENSITY', r'^TREND_INTENSITY\s*=\s*([\d.]+)'),
        ('SHRINK_K_OUTLIER_MID', r'^\s*SHRINK_K_OUTLIER_MID\s*=\s*([\d.]+)'),
        ('MEDIA_RUOLO_MID_PRIOR', r'^\s*MEDIA_RUOLO_MID_PRIOR\s*=\s*([\d.]+)'),
        ('SPLIT_SHRINK_K', r'SPLIT_SHRINK_K\s*=\s*([\d.]+)'),
        ('prior_dinamico', PRIOR_RE),
    ]),
    'fwd': ('test_mls_fwd_all.py', [
        ('HALF_LIFE_GAMES', r'^HALF_LIFE_GAMES\s*=\s*([\d.]+)'),
        ('TREND_INTENSITY', r'^TREND_INTENSITY\s*=\s*([\d.]+)'),
        ('SHRINK_K_OUTLIER_FWD', r'^\s*SHRINK_K_OUTLIER_FWD\s*=\s*([\d.]+)'),
        ('SPLIT_SHRINK_K', r'SPLIT_SHRINK_K\s*=\s*([\d.]+)'),
        ('prior_dinamico', PRIOR_RE),
    ]),
}
