...
OUTPUT_DIR = 'formazione_svezia/output/svezia_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_svezia/output/svezia_def_discovery', 'player_slugs.json')
