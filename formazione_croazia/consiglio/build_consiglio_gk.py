...
OUTPUT_DIR = 'formazione_croazia/output/croazia_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_croazia/output/croazia_gk_discovery', 'player_slugs.json')
