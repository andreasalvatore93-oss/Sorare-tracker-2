...
ROLES = {
    'GK': 'formazione_croazia/output/croazia_gk_all',
    'DEF': 'formazione_croazia/output/croazia_def_all',
    'MID': 'formazione_croazia/output/croazia_mid_all',
    'FWD': 'formazione_croazia/output/croazia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_croazia/output/croazia_gk_discovery',
    'DEF': 'formazione_croazia/output/croazia_def_discovery',
    'MID': 'formazione_croazia/output/croazia_mid_discovery',
    'FWD': 'formazione_croazia/output/croazia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_croazia/output'
