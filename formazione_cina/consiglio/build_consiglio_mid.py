...
OUTPUT_DIR = 'formazione_cina/output/cina_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_cina/output/cina_mid_discovery', 'player_slugs.json')
