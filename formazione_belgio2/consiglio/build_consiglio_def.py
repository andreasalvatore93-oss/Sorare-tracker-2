...
OUTPUT_DIR = 'formazione_belgio2/output/belgio2_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_belgio2/output/belgio2_def_discovery', 'player_slugs.json')
