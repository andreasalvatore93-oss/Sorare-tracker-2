...
# formazione_belgio2/predict/test_mid.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_belgio2/output/belgio2_mid_discovery_global' if CALIBRATION_MODE else 'formazione_belgio2/output/belgio2_mid_discovery',
    'player_slugs.json')
...
OUTPUT_DIR = 'formazione_belgio2/output/belgio2_mid_calibration' if CALIBRATION_MODE else 'formazione_belgio2/output/belgio2_mid_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_belgio2_mid.marker'
...
def compute_score_atteso_mid(scores, is_home_flags, opponent_rankings,
                             ...
                             target_opponent_team_slug=None, target_cutoff_dt=None, league='belgio2',
...
def rigorous_backtest_prod_mid(scores, is_home_flags, opponent_rankings,
                               ...
                               presence_rate=None, league='belgio2', detail_ok_flags=None):
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'belgio2', 'mid', next_opponent_team_slug, datetime.datetime.utcnow())
    ...
    score_atteso = compute_score_atteso_mid(
        ...
        target_cutoff_dt=_opp_cutoff, league='belgio2', detail_ok_flags=detail_ok_flags)
