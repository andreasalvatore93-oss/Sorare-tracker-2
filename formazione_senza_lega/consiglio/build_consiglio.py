...
OUTPUT_DIR = 'formazione_senza_lega/output/senza_lega_fwd_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_senza_lega/output/senza_lega_fwd_discovery', 'player_slugs.json')
