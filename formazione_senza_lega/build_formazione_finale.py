...
ROLES = {
    'GK': 'formazione_senza_lega/output/senza_lega_gk_all',
    'DEF': 'formazione_senza_lega/output/senza_lega_def_all',
    'MID': 'formazione_senza_lega/output/senza_lega_mid_all',
    'FWD': 'formazione_senza_lega/output/senza_lega_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_senza_lega/output/senza_lega_gk_discovery',
    'DEF': 'formazione_senza_lega/output/senza_lega_def_discovery',
    'MID': 'formazione_senza_lega/output/senza_lega_mid_discovery',
    'FWD': 'formazione_senza_lega/output/senza_lega_fwd_discovery',
}

OUTPUT_DIR = 'formazione_senza_lega/output'
