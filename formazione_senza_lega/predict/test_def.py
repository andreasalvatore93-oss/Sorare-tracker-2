...
# Fallback statico SOLO se senza_lega_def_discovery/player_slugs.json non esiste
...
# Portogallo, Austria, Scozia, Senza campionato, Olanda, Spagna), ricalibrata sessione
