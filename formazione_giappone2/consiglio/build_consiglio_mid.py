...
OUTPUT_DIR = 'formazione_giappone2/output/giappone2_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_giappone2/output/giappone2_mid_discovery', 'player_slugs.json')
