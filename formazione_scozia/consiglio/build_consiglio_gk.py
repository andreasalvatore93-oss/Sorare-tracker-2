...
OUTPUT_DIR = 'formazione_scozia/output/scozia_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_scozia/output/scozia_gk_discovery', 'player_slugs.json')
