...
OUTPUT_DIR = 'formazione_scozia/output/scozia_mid_all'
# CONSIGLIO_DISCOVERY_FILE (31/07, stessa patch propagata ad austria/croazia/
# germania2 -- vedi commit 1db59630ba): permette a best_five.py di puntare al
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_scozia/output/scozia_mid_discovery', 'player_slugs.json')
