...
ROLES = {
    'GK': 'formazione_scozia/output/scozia_gk_all',
    'DEF': 'formazione_scozia/output/scozia_def_all',
    'MID': 'formazione_scozia/output/scozia_mid_all',
    'FWD': 'formazione_scozia/output/scozia_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_scozia/output/scozia_gk_discovery',
    'DEF': 'formazione_scozia/output/scozia_def_discovery',
    'MID': 'formazione_scozia/output/scozia_mid_discovery',
    'FWD': 'formazione_scozia/output/scozia_fwd_discovery',
}

OUTPUT_DIR = 'formazione_scozia/output'
