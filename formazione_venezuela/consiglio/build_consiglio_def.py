...
OUTPUT_DIR = 'formazione_venezuela/output/venezuela_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_venezuela/output/venezuela_def_discovery', 'player_slugs.json')
