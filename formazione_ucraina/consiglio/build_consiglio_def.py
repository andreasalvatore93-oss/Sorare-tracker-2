...
OUTPUT_DIR = 'formazione_ucraina/output/ucraina_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_ucraina/output/ucraina_def_discovery', 'player_slugs.json')
