...
OUTPUT_DIR = 'formazione_cipro/output/cipro_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_cipro/output/cipro_mid_discovery', 'player_slugs.json')
