...
OUTPUT_DIR = 'formazione_cipro/output/cipro_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_cipro/output/cipro_def_discovery', 'player_slugs.json')
