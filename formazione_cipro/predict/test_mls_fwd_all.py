...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_cipro/diagnostics/
...
# formazione_cipro/diagnostics/validate_outlier_shrinkage.py (variabile
...
def build_prediction(player_slug):
    ...
    # formazione_cipro/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='cipro', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
