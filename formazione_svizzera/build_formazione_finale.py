...
ROLES = {
    'GK': 'formazione_svizzera/output/svizzera_gk_all',
    'DEF': 'formazione_svizzera/output/svizzera_def_all',
    'MID': 'formazione_svizzera/output/svizzera_mid_all',
    'FWD': 'formazione_svizzera/output/svizzera_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_svizzera/output/svizzera_gk_discovery',
    'DEF': 'formazione_svizzera/output/svizzera_def_discovery',
    'MID': 'formazione_svizzera/output/svizzera_mid_discovery',
    'FWD': 'formazione_svizzera/output/svizzera_fwd_discovery',
}

OUTPUT_DIR = 'formazione_svizzera/output'
