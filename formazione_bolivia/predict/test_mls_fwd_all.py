...
# formazione_bolivia/predict/test_mls_fwd_all.py`, quindi l'import diretto
...
DISCOVERY_FILE = os.path.join(
    'formazione_bolivia/output/bolivia_fwd_discovery_global' if CALIBRATION_MODE else 'formazione_bolivia/output/bolivia_fwd_discovery',
    'player_slugs.json')
...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_bolivia/diagnostics/
...
# formazione_bolivia/diagnostics/validate_outlier_shrinkage.py (variabile
...
OUTPUT_DIR = 'formazione_bolivia/output/bolivia_fwd_calibration' if CALIBRATION_MODE else 'formazione_bolivia/output/bolivia_fwd_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_bolivia_fwd.marker'
...
def rigorous_backtest_prod_fwd(scores, is_home_flags,
                               ...
                               opponent_team_slugs_hist=None, league='bolivia',
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'bolivia', 'fwd', next_opponent_team_slug, _opp_cutoff)
    ...
    # formazione_bolivia/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='bolivia', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
