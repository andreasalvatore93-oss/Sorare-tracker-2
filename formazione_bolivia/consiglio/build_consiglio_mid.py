...
OUTPUT_DIR = 'formazione_bolivia/output/bolivia_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_bolivia/output/bolivia_mid_discovery', 'player_slugs.json')
