...
OUTPUT_DIR = 'formazione_olanda2/output/olanda2_mid_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_olanda2/output/olanda2_mid_discovery', 'player_slugs.json')
