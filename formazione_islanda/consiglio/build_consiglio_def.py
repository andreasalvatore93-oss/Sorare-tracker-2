...
OUTPUT_DIR = 'formazione_islanda/output/islanda_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_islanda/output/islanda_def_discovery', 'player_slugs.json')
