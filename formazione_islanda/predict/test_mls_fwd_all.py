...
# backtest walk-forward rigoroso su tutti i ruoli (formazione_islanda/diagnostics/
...
# formazione_islanda/diagnostics/validate_outlier_shrinkage.py (variabile
...
def build_prediction(player_slug):
    ...
    # formazione_islanda/diagnostics/selection_quality.py (variante FWD, 74
    ...
    score_ordinamento = compute_score_atteso_fwd(
        ...
        league='islanda', offensive_values=offensive_values,
        detail_ok_flags=detail_ok_flags)
