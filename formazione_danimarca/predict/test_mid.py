"""
test_mid (test centrocampista Superliga (Danimarca) — prototipo, clone adattato di test_mls_fwd_all.py)
...
# Fallback statico SOLO se danimarca_mid_discovery/player_slugs.json non esiste
...
def build_prediction(player_slug):
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'danimarca', 'mid', next_opponent_team_slug, _opp_cutoff)
