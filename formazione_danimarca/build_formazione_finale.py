...
ROLES = {
    'GK': 'formazione_danimarca/output/danimarca_gk_all',
    'DEF': 'formazione_danimarca/output/danimarca_def_all',
    'MID': 'formazione_danimarca/output/danimarca_mid_all',
    'FWD': 'formazione_danimarca/output/danimarca_fwd_all',
}

DISCOVERY_DIRS = {
    'GK': 'formazione_danimarca/output/danimarca_gk_discovery',
    'DEF': 'formazione_danimarca/output/danimarca_def_discovery',
    'MID': 'formazione_danimarca/output/danimarca_mid_discovery',
    'FWD': 'formazione_danimarca/output/danimarca_fwd_discovery',
}

OUTPUT_DIR = 'formazione_danimarca/output'
