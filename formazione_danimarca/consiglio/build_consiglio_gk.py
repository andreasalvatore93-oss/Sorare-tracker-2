...
OUTPUT_DIR = 'formazione_danimarca/output/danimarca_gk_all'
...
# sempre).
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_danimarca/output/danimarca_gk_discovery', 'player_slugs.json')
