...
OUTPUT_DIR = 'formazione_slovacchia/output/slovacchia_fwd_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_slovacchia/output/slovacchia_fwd_discovery', 'player_slugs.json')
