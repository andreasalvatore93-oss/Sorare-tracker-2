...
OUTPUT_DIR = 'formazione_peru/output/peru_gk_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_peru/output/peru_gk_discovery', 'player_slugs.json')
