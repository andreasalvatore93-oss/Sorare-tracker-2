...
# formazione_peru/predict/test_def.py`, quindi l'import diretto funziona a
...
DISCOVERY_FILE = os.path.join(
    'formazione_peru/output/peru_def_discovery_global' if CALIBRATION_MODE else 'formazione_peru/output/peru_def_discovery',
    'player_slugs.json')
...
# (formazione_peru/diagnostics/validate_outlier_shrinkage.py) mostra che tirare
...
OUTPUT_DIR = 'formazione_peru/output/peru_def_calibration' if CALIBRATION_MODE else 'formazione_peru/output/peru_def_all'
...
_CIRCUIT_BREAKER_PATH = '/tmp/sorare_cloudfront_block_peru_def.marker'
...
# Logica identica a formazione_peru/diagnostics/validate_level_score_event_rate.py,
...
def compute_score_atteso_def(scores, is_home_flags, opponent_rankings,
                             ...
                             next_opponent_team_slug=None, next_game_date=None, league='peru',
...
def rigorous_backtest_prod_def(scores, is_home_flags, opponent_rankings,
                               ...
                               opponent_team_slugs_hist=None, game_dates_hist=None, league='peru',
...
def build_prediction(player_slug):
    ...
    if CALIBRATION_MODE and not future_games:
        ...
        grid_results = run_grid_search_prod_def(
            ...
            min_history=6,
            opponent_team_slugs_hist=opponent_team_slugs_hist,
            game_dates_hist=game_dates_hist, league='peru',
            presence_rate=presence_rate, detail_ok_flags=detail_ok_flags)
    ...
    _opp_lambda_mult = opponent_strength.opponent_lambda_multiplier(
        'peru', 'def', next_opponent_team_slug, _opp_cutoff)
    ...
    # formazione_peru/diagnostics/selection_quality.py (lift catturato fra
    ...
    score_ordinamento = compute_score_atteso_def(
        ...
        league='peru', detail_ok_flags=detail_ok_flags)
