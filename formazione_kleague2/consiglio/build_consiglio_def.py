...
OUTPUT_DIR = 'formazione_kleague2/output/kleague2_def_all'
...
DISCOVERY_FILE = os.environ.get('CONSIGLIO_DISCOVERY_FILE') or os.path.join('formazione_kleague2/output/kleague2_def_discovery', 'player_slugs.json')
